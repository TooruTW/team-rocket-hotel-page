    ...
    <form class="z-10 min-w-416/960 max-2xl:w-full p-5 flex flex-col gap-10 " action="">
                    ...
                    <div v-if="!isStage1Pass" class="flex flex-col gap-2">
                        ...
                        <label class=" font-bold text-base max-md:text-14 leading-[1.5] tracking-wide w-full flex flex-col gap-2" for="">
                            ...
                            <input v-model="user.password" class="w-full rounded-md p-4 bg-theme-neutral-40 text-theme-neutral-60 font-medium" type="text" placeholder="請輸入密碼">
                        </label>
                        <label class=" font-bold text-base max-md:text-14 leading-[1.5] tracking-wide w-full flex flex-col gap-2" for="">
                            <p class="flex gap-2 items-center">
                                確認密碼 <span class="text-14 text-theme-alert-100">  {{ validatorPasswordConfirem }} </span>
                            </p>
                            <input v-model="userPasswordConfirm" class="w-full rounded-md p-4 bg-theme-neutral-40 text-theme-neutral-60 font-medium" type="text" placeholder="請再輸入一次密碼">
                        </label>
                    ...
                    <div v-if="isStage1Pass" class="flex flex-col gap-2">
                        ...
                        <label class=" font-bold text-base max-md:text-14 leading-[1.5] tracking-wide w-full flex flex-col gap-2" for="phoneNum">
                            <p class="flex items-center gap-2">手機號碼 <span class="text-14 text-theme-alert-100">{{ validatorPhone }}</span></p>
                            <input v-model="user.phone" id="phoneNum" class="w-full rounded-md p-4 bg-theme-neutral-40 text-theme-neutral-60 font-medium" type="text" placeholder="請輸入手機號碼">
                        </label>
                        <label class=" font-bold text-base max-md:text-14 leading-[1.5] tracking-wide" for="year">
                            <p class="flex items-center gap-2">生日 <span class="text-14 text-theme-alert-100">{{ validatorBirthday }}</span></p>
                            <div class="flex font-medium justify-between gap-2 text-theme-neutral-80">
                                ...
                                <div class="w-full flex items-center relative bg-theme-neutral-0 rounded-md">
                                    <select @change="formatorBirthday" class="appearance-none p-4 w-full" name="year" id="year" v-model="selectedYear">
                                ...
                                <!-- month -->
                                <div class="w-full flex items-center relative bg-theme-neutral-0 rounded-md">
                                    <select @change="formatorBirthday" class="appearance-none p-4 w-full" name="month" id="month" v-model="selectedMonth">
                                ...
                                <!-- day -->
                                <div class="w-full flex items-center relative bg-theme-neutral-0 rounded-md">
                                    <select @change="formatorBirthday" class="appearance-none p-4 w-full" name="day" id="day" v-model="selectedDay">
                        ...
                        <label class=" font-bold text-base max-md:text-14 leading-[1.5] tracking-wide w-full flex flex-col gap-2" for="">
                            <p class="flex items-center gap-2">地址 <span class="text-14 text-theme-alert-100">{{ validatorAddress }}</span></p>
                            ...
                            <input v-model="user.address.detail" class="w-full rounded-md p-4 bg-theme-neutral-40 text-theme-neutral-60 font-medium" type="text" placeholder="請輸入詳細地址">
                        </label>
                        <label for="reade" class="flex gap-2">
                            <input v-model="user.isReaded" id="readed" type="checkbox">
                            <p class="flex items-center gap-2">我已閱讀並同意本網站個資使用規範 
                                <span class="text-14 text-theme-alert-100">{{ validatorAggrement }}</span>
                            </p>
                        </label>
