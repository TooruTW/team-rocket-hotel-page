    ...
    <div class="flex justify-center w-full pt-30 pb-42 bg-theme-primary-10">
        ...
        <div class="flex flex-col gap-20 w-1296/1920">
            ...
            <div>
                ...
                <h1 class="text-48 text-theme-primary-100 font-bold leading-[1.2] tracking-wider">各種房型，任您挑選</h1>
            </div>
            <!-- card container -->
            <div class="w-full">
                <!-- cards -->
                <div class="w-full flex rounded-3xl overflow-hidden ">
                    ...
                    <div class="flex flex-col gap-10 w-2/5 bg-theme-neutral-0 p-10">
                        <!-- text content -->
                        <div>
                            <h1  class="text-40 text-theme-neutral-100 font-bold leading-[1.2] tracking-wider">RoomName</h1>
                            <p  class="text-16 text-theme-neutral-80 font-medium leading-[1.5] tracking-wide">Description</p>
                        </div>
                        <!-- box content -->
                        <div class=" flex gap-4">
                            <div class="p-4 border-1 border-theme-primary-40 rounded-md aspect-square flex flex-col justify-center gap-2">
                        ...
                        <div class="flex items-center justify-between">
                            <h5  class="text-24 text-theme-primary-100 font-bold leading-[1.2] tracking-wider">Price</h5>
