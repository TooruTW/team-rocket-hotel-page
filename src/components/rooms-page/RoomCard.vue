...
<template>
  <div
    class="w-full flex rounded-3xl overflow-hidden max-md:flex-col max-md:h-135"
  >
    <!-- slider -->
    <Slider
      class="w-3/5 max-md:w-full max-md:h-1/3"
      :dataArr="props.dataObj.imageUrlList"
      :btn="showBTN"
    ></Slider>
    ...
    <div
      class="flex flex-col justify-between gap-10 w-2/5 bg-theme-neutral-0 p-10 max-md:p-4 max-md:w-full max-md:h-2/3 max-md:gap-6"
    >
      <!-- text content -->
      <div>
        <h1
        ...
        <p
          class="text-16 text-theme-neutral-80 font-medium leading-[1.5] tracking-wide max-md:text-14"
        >
      ...
      <div class="flex gap-4 max-md:justify-between">
        <div
          class="w-24 p-4 border-1 border-theme-primary-40 rounded-md aspect-square flex flex-col justify-center gap-2"
        >
          <svg
            width="24"
            height="25"
          ...
          <h3 class="text-16 font-bold text-theme-neutral-80 max-md:text-14">
            {{ props.dataObj.areaInfo }}
          </h3>
        </div>
        <div
          class="w-24 p-4 border-1 border-theme-primary-40 rounded-md aspect-square flex flex-col justify-center gap-2"
