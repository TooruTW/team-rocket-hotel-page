...
<template>
    <div class="w-full flex rounded-3xl overflow-hidden ">
        <Slider class="w-3/5" :dataArr="props.dataObj.imageUrlList"></Slider>
    <!-- right content -->
    <div class="flex flex-col gap-10 w-2/5 bg-theme-neutral-0 p-10">
        <!-- text content -->
        <div>
            <h1  class="text-40 text-theme-neutral-100 font-bold leading-[1.2] tracking-wider">{{ props.dataObj.name }}</h1>
            <p  class="text-16 text-theme-neutral-80 font-medium leading-[1.5] tracking-wide">{{ props.dataObj.description }}</p>
        </div>
        <!-- box content -->
        <div class=" flex gap-4">
            ...
            <div class="w-24 p-4 border-1 border-theme-primary-40 rounded-md aspect-square flex flex-col justify-center gap-2">
                ...
                <h3>{{ props.dataObj.maxPeople }} 人</h3>
            </div>
        </div>
        <!-- deco line -->
        ...
        <div class="flex items-center justify-between">
            <h5  class="text-24 text-theme-primary-100 font-bold leading-[1.2] tracking-wider">NT$ {{ props.dataObj.price }}</h5>
