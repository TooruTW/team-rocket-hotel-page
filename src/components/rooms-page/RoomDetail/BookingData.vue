...
<template>
    <form class="z-10 min-w-416/960 max-2xl:w-full flex flex-col gap-10 " action="">
                    ...
                    <div v-if="!isStage1Pass" class="flex flex-col gap-2">
                        <label class=" font-bold text-base max-md:text-14 leading-[1.5] tracking-wide w-full flex flex-col gap-2" for="fullName">
                            ...
                            <input v-model="user.name" id="fullName" class="w-full rounded-md p-4 bg-theme-neutral-0 text-theme-neutral-60 font-medium" type="text" placeholder="請輸入姓名">
                        </label>
                        <label class=" font-bold text-base max-md:text-14 leading-[1.5] tracking-wide w-full flex flex-col gap-2" for="phoneNum">
                            ...
                            <input v-model="user.phone" id="phoneNum" class="w-full rounded-md p-4 bg-theme-neutral-0 text-theme-neutral-60 font-medium" type="text" placeholder="請輸入手機號碼">
                        </label>
                        <label class=" font-bold text-base max-md:text-14 leading-[1.5] tracking-wide w-full flex flex-col gap-2" for="email">
                            ...
                            <input @change="checkEmailIsRegisted(user.email)" v-model="user.email" id="email" class="w-full rounded-md p-4 bg-theme-neutral-0 text-theme-neutral-60 font-medium" type="text" placeholder="hello@exsample.com">
                        </label>
                        <label class=" font-bold text-base max-md:text-14 leading-[1.5] tracking-wide w-full flex flex-col gap-2" for="">
                            ...
                            <input v-model="user.address.detail" class="w-full rounded-md p-4 bg-theme-neutral-0 text-theme-neutral-60 font-medium" type="text" placeholder="請輸入詳細地址">
                        </label>
                    </div>
