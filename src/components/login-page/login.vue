...
<template>
    <div class="w-full h-screen bg-theme-neutral-bg ">
        <nav class="w-full h-120/1080 flex items-center">
            <img class="w-48 ml-20" src="/public/hotel-icon.png" alt="hotel-icon">
        </nav>
        <div class="w-full h-960/1080 flex text-theme-neutral-0 ">
            ...
            <div class="w-1/2 flex flex-col justify-center items-center relative">
                ...
                <form class="z-10 w-416/960 flex flex-col gap-10 " action="">
                    ...
                    <div class="flex flex-col gap-2">
                        <label class=" font-bold text-base leading-[1.5] tracking-wide w-full flex flex-col gap-2" for="">
                            電子信箱
                            <input class="w-full rounded-md p-4 bg-theme-neutral-40 text-theme-neutral-60" type="text" placeholder="hello@exsample.com">
                        </label>
                        <label class=" font-bold text-base leading-[1.5] tracking-wide w-full flex flex-col gap-2" for="">
                            密碼
                    ...
                    <button class="w-full rounded-md p-4 bg-theme-neutral-40 text-theme-neutral-60">會員登入</button>
                    <h4>沒有會員嗎？
